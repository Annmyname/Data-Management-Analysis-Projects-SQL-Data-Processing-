...
--- LÀM BÀI TẬP
-- Phần I câu 3 đến câu 6, câu 11 đến câu 14
...
ALTER TABLE GIANGDAY ADD CONSTRAINT CHECK_GD CHECK (TUNGAY < DENNGAY)

-- 13 Giáo viên khi vào làm ít nhất là 22 tuổi
ALTER TABLE GIAOVIEN ADD CONSTRAINT CHECK_TUOILAMVIEC CHECK (YEAR(NGVL) - YEAR(NGSINH) >= 22)

-- 14 Tất cả các môn học đều có số tín chỉ lý thuyết và tín chỉ thực hành chênh lệch nhau không quá 3
ALTER TABLE MONHOC ADD CONSTRAINT CHECK_TC CHECK (ABS(TCLT - TCTH) <= 3)

-- Phần III câu 1 đến câu 5
...
WHERE KETQUATHI.MAHV = MONHOC.MAMH AND KETQUATHI.MAHV = HOCVIEN.MAHV AND LANTHI = 1 AND KQUA = 'Dat'

-- 4 In ra danh sách học viên (mã học viên, họ tên) của lớp “K11” thi môn CTRR không đạt (ở lần thi 1)
SELECT HOCVIEN.MAHV, (HO+' '+TEN) HOTEN
FROM HOCVIEN, KETQUATHI
WHERE HOCVIEN.MAHV = KETQUATHI.MAHV AND MALOP = 'K11' AND MAMH = 'CTRR' AND KQUA = 'Khong Dat' AND LANTHI = 1
